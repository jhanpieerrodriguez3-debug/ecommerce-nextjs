 ...
 *     description: Devuelve el listado de almacenes desde Supabase. Si la base de datos no está disponible, retorna datos de respaldo (fallback).
 *     responses:
 *       200:
 ...
 *     description: Devuelve la información de un almacén específico.
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *     tags:
 *       - Stores
 *     summary: Obtener resumen del almacén.
 *     description: Devuelve estadísticas generales del almacén, incluyendo productos, pedidos activos y ventas del día.
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
